...
**Alternate taglines (swap if preferred):**
1. Behind the lens of Indian enterprise.
2. Thirty-three years in frame.
3. Since 1993. One studio. India's work.
...
**Sub:** Seven disciplines. One studio.

Cards (title only, link to Services page):
1. Filmmaking
2. Event Coverage
3. Expo Coverage
4. Product Shoot
...
### Portfolio Teaser
**Heading:** The work.
**Body:** Decades of frames, condensed into a single reel.
**CTA:** Watch the showreel →
...
**3. Expo Coverage**
*One-line:* Trade shows, exhibitions and industry expos, across India.
*What we deliver:* Booth films, walkthrough coverage, attendee interviews, daily on-site edits.

**4. Product Shoot**
*One-line:* Studio and on-location product photography.
*What we deliver:* Catalogue, e-commerce, advertising and packaging-ready imagery.
...
*What we deliver:* Pre-event coverage, live multi-camera capture, post-event edits, broadcast-ready output.

**7. Industrial Shoot**
*One-line:* Factories, plants, processes, infrastructure.
*What we deliver:* Process films, safety documentation, plant tours, B2B sales videos and stills for the manufacturing sector.

### Closing Line
If your shoot isn't on this list, ask. In thirty-three years, we've likely done it.
**CTA:** Brief Us
...
- What are you shooting? *(dropdown: Filmmaking / Event / Expo / Product / Corporate Shoot / Corporate Event / Industrial / Other)*
- Tell us more *(textarea)*

**Submit button:** Send Enquiry
**Success state:** Received. We'll be in touch within one working day.
...
Logo (horizontal lockup) on left. Right side:
Home · About · Services · Portfolio · Contact · **Get in Touch** (button, gold accent)
...
## 9. MICRO-COPY (UI strings)

- 404 page heading: This frame doesn't exist.
- 404 page body: Let's get you back to ones that do.
- 404 CTA: Return Home
- Loading state: Loading…
- Form sending state: Sending…
- Cookie banner (if used): We use cookies to understand site usage. That's it.
